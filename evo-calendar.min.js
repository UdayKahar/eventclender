  ...
  ((t = (function () {
    ...
    (t.prototype.addEventList = function (e) {
      ...
      0 === n.find("[data-event-index]").length && n.empty(),
        ...
        (t =
          `<a href="${e.link}">`+`<div class="event-container" role="button" data-event-index="` +
          e.id +
          '">'),
        ...
        (t +=  e.img?`<a href="${e.link}"  target="_blank">`+`<img class="eventImg" alt=""  target="_blank"  src="${e.img}"> </a>`:"<div></div>"),
        n.append(t),
        a.$elements.eventEl
